...
% TODO: ultimo cite é do trabalho que fala do repositorio. coloquei felder para mandar pra fazer a ficha catalografica hihihi
...
O questionário USE avalia a usabilidade de um sistema baseado em 3 pontos de vista: utilidade, simplicidade de aprender e facilidade de uso. O primeiro grupo de questões que são avaliadas a seguir pertencem ao grupo utilidade. 

A primeira questão do questionário pergunta ao usuário se o sistema o ajudou a ser mais efetivo. Dos 9 alunos, nenhum marcou no ponto médio ou abaixo dele, 6 marcaram um nível acima do ponto médio, 1 marcou 2 pontos acima da média e 2 como \emph{Concordo fortemente}. A Figura \ref{fig:mais_efetivo} mostra graficamente esta relação.
...
A questão sobre se o sistema ajuda o aluno a ser mais produtivo, as respostas dos alunos ficaram acima da média, onde 3 deles marcaram médio, 1 marcou um ponto acima da média, 3 marcaram 2 pontos acima da média e 2 como \emph{Concordo fortemente}. A Figura \ref{fig:mais_produtivo} mostra graficamente as repostas.
...
Estas duas questões reforçam alguns itens já discutidos anteriormente, que o sistema Mindboard favorece o aluno a ter interações de mais qualidade e aumentar o foco na aula, tornando-os mais efetivos e produtivos durante a aula.

Quando questionados se a ferramenta é útil, todos os alunos concordam fortemente ou um nível abaixo deste. Nesse caso, 6 alunos marcaram um ponto abaixo de \emph{Concordo fortemente} e 3 marcaram como \emph{Concordo fortemente}, o que nos mostra que o sistema teve um alto grau de utilidade ao aluno.

Foi questionado também se a ferramenta permite ao aluno controlar/acompanhar as aulas utilizando o sistema, e 6 alunos concordam fortemente com esta afirmação, 2 alunos marcaram 1 ponto abaixo de \emph{Concordo fortemente} e 1 aluno 2 pontos abaixo. A Figura \ref{fig:permite_controlar} mostra graficamente estas respostas. As respostas a essa questão geram indícios que o objetivo do sistema do ponto de vista dos alunos foi atingido.
