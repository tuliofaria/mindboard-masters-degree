...
Usar sempre fonte Times New Roman, sem exceção. 

Usar sempre cor preta.

Usar sempre tamanho de fonte 12, com as seguintes exceções: tamanho de fonte 10 para citações longas (com mais de três linhas), notas de rodapé, legendas de ilustração e de tabela, fontes de ilustração e de tabela, números de página; e tamanho de fonte maiores para títulos de seção (tamanho de fonte 16 para seções primárias, tamanho de fonte 14 para seções secundárias, e tamanho de fonte 12 para seções terciárias em diante).
